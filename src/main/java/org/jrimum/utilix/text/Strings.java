...
public final class Strings {
	 ...
	 *             - Caso a string seja <code>null</code> ou
	...
	/**
	 * Verifica se a <code>String</code> passada por parâmetro não é
	 * <code>null</code>, não é vazia (<code>StringUtils.EMPTY</code>) e não possui apenas
	 * espaços em branco.
	 * <p>
	 * Lança exceção, com a mensagem passada por parâmetro (segundo parâmetro
	 * String), caso não preencha estes requisitos.
	...
	public static void checkNotBlank(String value) {
		...
		checkNotBlank(value, "String nula!", format("Valor inválido. String [\"%s\"] vazia ou contendo somente espaços em branco!", value));
	}
	...
	public static String fillWithZeroLeft(String stringToFill, int length) {
		return StringUtils.leftPad(stringToFill, length, "0");
	}
}
